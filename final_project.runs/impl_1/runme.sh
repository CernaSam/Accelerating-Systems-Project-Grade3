...
HD_PWD='/home/deazon/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log final_project_grade_3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source final_project_grade_3_wrapper.tcl -notrace
