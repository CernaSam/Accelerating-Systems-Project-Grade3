...
HD_PWD='/home/deazon/final_project/final_project.runs/final_project_grade_3_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_project_grade_3_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source final_project_grade_3_processing_system7_0_0.tcl
