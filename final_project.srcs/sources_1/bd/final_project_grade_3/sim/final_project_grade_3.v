...
//Date        : Wed Jan 14 01:17:03 2026
//Host        : deazon running 64-bit Ubuntu 24.04.1 LTS
//Command     : generate_target final_project_grade_3.bd
//Design      : final_project_grade_3
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "final_project_grade_3,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=final_project_grade_3,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "final_project_grade_3.hwdef" *) 
module final_project_grade_3
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  final_project_grade_3_processing_system7_0_0 processing_system7_0
