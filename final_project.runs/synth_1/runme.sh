...
HD_PWD='/home/deazon/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_project_grade_3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source final_project_grade_3_wrapper.tcl
